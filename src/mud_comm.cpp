...
CMDF( do_mpbodybag )
{
    ...
    * * --Shaddai
    */
   log_printf( "Mpbodybag: Grabbed {}", buf );
}
...
CMDF( do_mpsindhae )
{
   ...
   log_printf( "{} is beginning redemption for {} {} Sindhae prize.", victim->name, argument, Class );
...
CMDF( do_mpredo )
{
   ...
   log_printf( "{} is restarting creation from end room.\r\n", victim->name );
