...
#define COPYRIGHT "Copyright The Alsherok Team 1997-2007. All rights reserved."
...
enum pc_flags
{
   ...
   PCFLAG_GROUPWHO, PCFLAG_HIGHGAG, PCFLAG_WATCH, PCFLAG_HELPSTART,
   ...
   PCFLAG_AUTOSAC, PCFLAG_BLANK, PCFLAG_BRIEF, PCFLAG_AUTOMAP, PCFLAG_unused2,
