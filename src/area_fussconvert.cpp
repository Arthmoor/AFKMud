...
void load_room_reset( room_index * room, FILE * fp )
{
   exit_data *pexit;
   char letter;
    ...
    * Reset probabilities are assumed to be 100% for conversions.
    */
   switch ( letter )
   {
      default:
      ...
      case 'D':
         if( arg2 < 0 || arg2 > MAX_DIR + 1
             || !( pexit = room->get_exit( arg2 ) ) || !IS_EXIT_FLAG( pexit, EX_ISDOOR ) )
         {
   ...
   room->add_reset( letter, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11 );

   if( !not01 )
      room->renumber_put_resets( );
   return;
}
