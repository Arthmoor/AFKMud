...
#define THIS_SERVICE "AFKMud"
#define THIS_SERVICE_DISPLAY "AFKMud C++ for Win32"
...
// do not start the SMAUG if it is already a running service
   ...
   else
   {
      ...
      // do not start AFKMud if it is already a running service
      ...
      fprintf( stderr, "Attempting to start AFKMud as a service ...\n" );
